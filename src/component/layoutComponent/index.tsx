...
export default function LayoutComponent() {
  ...
  //           `https://ybdigitalx.com/vivi_backend/getUser.php`,
  //           {
  //             method: "POST",
  //             headers: {
    ...
    <div className="layoutComponent">
      ...
      <div className="layoutLinks">
        ...
        <Link
          ...
          className={pathname === "/admin/videoupload" ? "active" : ""}
        >
        ...
        <Link
          href="/admin/courses"
          className={pathname === "/admin/courses" ? "active courses-link" : "courses-link"}
        >
